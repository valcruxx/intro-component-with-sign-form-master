...
button.onclick = function(){
    ...
    if(
        fName.value == ""
            ...
            fName.style.backgroundPositionX = "right";
        ...
        if(
            lName.value == ""
                ...
                lName.style.backgroundPositionX = "right";
        ...
        if(
            myEmail.value == ""
                ...
                myEmail.style.backgroundPositionX = "right";
                myEmail.style.backgroundPositionY = "center";
        ...
        if(
            password.value == ""
                ...
                password.style.backgroundPositionX = "right";
